// IEEE1364-2005 17.2.9 p297: an address-free file with 2 data words
...
// digital-runner: warning memory file data word count does not match load range: found 2, expected 4
//! inherited IEEE 1364-2005 17.2.9
module audit_readmem_warn_hex_short_down;
  reg [7:0] mem[3:0];
  integer i;
  initial begin
