...
| `a-3` A.3 | `56_gate_instantiation_unsupported.va` — grammar only, W0252; behaviour is `ieee1364/07_gate_switch_level/d08_*` | `reject_A_3_4_gate_type_fixes_the_terminal_count.va` |
| `a-4` A.4 | `11_module_instantiation.va` | `reject_A_4_1_instance_without_port_list.va` |
| `a-5` A.5 | `58_udp_declaration_unsupported.va` — grammar only, W0252; behaviour is `ieee1364/08_udp/d08_udp_*` | `reject_A_5_1_udp_without_table.va` |
