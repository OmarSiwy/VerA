...
const fixture_entries = blk: {
    const paths = [_][]const u8{
        // 01_gates
        "fixtures/conformance_v/01_gates/01_and2.v",
        "fixtures/conformance_v/01_gates/02_or2.v",
        "fixtures/conformance_v/01_gates/03_not.v",
        "fixtures/conformance_v/01_gates/04_nand2.v",
        "fixtures/conformance_v/01_gates/05_xor2.v",
        "fixtures/conformance_v/01_gates/06_and3.v",
        "fixtures/conformance_v/01_gates/07_xnor2.v",
        "fixtures/conformance_v/01_gates/08_buf.v",
        // 02_multibit
        "fixtures/conformance_v/02_multibit/01_adder4.v",
        "fixtures/conformance_v/02_multibit/02_mux2.v",
        "fixtures/conformance_v/02_multibit/03_comparator.v",
        "fixtures/conformance_v/02_multibit/04_decoder.v",
        // 03_sequential
        "fixtures/conformance_v/03_sequential/01_dff.v",
        "fixtures/conformance_v/03_sequential/02_register8.v",
        "fixtures/conformance_v/03_sequential/03_dff_negedge.v",
        // 04_operators
        "fixtures/conformance_v/04_operators/01_shifts.v",
        "fixtures/conformance_v/04_operators/02_concat.v",
        "fixtures/conformance_v/04_operators/03_ternary.v",
        "fixtures/conformance_v/04_operators/04_reduction.v",
        "fixtures/conformance_v/04_operators/05_arithmetic.v",
        // 05_edge_cases
        "fixtures/conformance_v/05_edge_cases/01_passthrough.v",
        "fixtures/conformance_v/05_edge_cases/02_constant.v",
        "fixtures/conformance_v/05_edge_cases/03_multi_output.v",
        "fixtures/conformance_v/05_edge_cases/04_case_mux.v",
    };

    var entries: [paths.len]FixtureEntry = undefined;
    for (paths, 0..) |p, i| {
        const stripped = p["fixtures/conformance_v/".len..];
        const dot = std.mem.lastIndexOfScalar(u8, stripped, '.').?;
        const json_path = "expected_v/" ++ stripped[0..dot] ++ ".json";
        entries[i] = .{
            .path = p,
            .source = @embedFile(p),
